...
public class RandomWords {
    ...
    public RandomWords() throws IOException {
        URL resource = getClass().getClassLoader().getResource("mooc/oracle/jdk8_lambdas_streams/words.txt");
        try (BufferedReader reader = Files.newBufferedReader(Paths.get(resource.getPath()))) {
