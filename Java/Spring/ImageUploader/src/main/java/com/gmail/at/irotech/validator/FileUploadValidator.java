package com.gmail.at.irotech.validator;
...
public class FileUploadValidator implements Validator {
	...
	private static final String[] ACCEPTED_CONTENT_TYPES = new String[] { "image/jpeg", "image/gif", "image/jpg", "image/png" };
	...
	public boolean supports(Class<?> arg0) {
		return FileUploadForm.class.equals(arg0);
	}
	...
	public void validate(Object obj, Errors errors) {
		...
		List<FileUpload> files = fileUploadForm.getFiles();
		...
		if (!acceptableContentType) {
			...
			errors.reject(
					"error.upload.dimension",
					"Please upload a image file with dimension at least " + MAX_DIMENSION/1024 + " KB.");
		}
