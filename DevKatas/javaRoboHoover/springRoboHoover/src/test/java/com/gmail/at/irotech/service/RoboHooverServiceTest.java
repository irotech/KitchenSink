...
public class RoboHooverServiceTest {
    ...
    @Test
    public void runCleaningWithSomeInvalidCommandsWith3StainsRemoved() throws Exception {
        request = new RoboHooverRequest(
                new int[] {10, 10},
                new int[] {10, 10},
                new int[][] {{10, 10},{10, 9},{10, 8}},
                "SSSSS");
        final RoboHooverResponse roboHooverResponse = service.runCleaning(request);
        assertEquals(new RoboHooverResponse(new int[] {10, 5}, 3, null), roboHooverResponse);
    }
